 ...
 * @author wilqor
 */
public interface MonthlyStatRepository extends CrudRepository<MonthlyStat, String>, CustomMonthlyStatRepository {
    Optional<MonthlyStat> findByMetaData(StatMetaData metaData);
}
