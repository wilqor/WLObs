 ...
 * @author wilqor
 */
public interface YearlyStatRepository extends CrudRepository<YearlyStat, String>, CustomYearlyStatRepository {
    Optional<YearlyStat> findByMetaData(StatMetaData metaData);
}
